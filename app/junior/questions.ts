const juniorQuestions = [
    ...
    {
      id: 2,
      question: "What's scope in JavaScript?",
      answer:
    ...
    },
    {
      id: 3,
      question:
        "Explain CSS 'box model' and its layout components.",
      answer:
    ...
    {
      id: 6,
      question: "What's Cross-Site Scripting (XSS)?",
      answer:
    ...
    {
      id: 14,
      question: "What's reactive programming?",
      answer:
    ...
    {
      id: 17,
      question: "Name 3 concepts of OOP applied to JavaScript.",
      answer:
    ...
    {
      id: 19,
      question: "What's an interface in TypeScript?",
      answer:
    ...
    {
      id: 20,
      question: "What's the meaning of Mock?",
      answer:
    ...
    {
      id: 21,
      question: "What's the GraphQL schema?",
      answer:
    ...
    {
      id: 22,
      question: "What's Virtual DOM and what are its advantages?",
      answer:
    ...
    {
      id: 23,
      question: "What's and how to use the Block Element Modifier convention?",
      answer:
    ...
    {
      id: 24,
      question: "How you can use JavaScript functions: forEach, Map or Reduce.",
      answer:
    ...
    {
      id: 25,
      question: "What's and how can you take advantage of PureComponent?",
      answer:
    ...
    {
      id: 26,
      question: "What's serverless computing?",
      answer:
    ...
    },
    {
      id: 29,
      question:
        "Difference between elements positioned: relative, fixed, absolute, and static?",
      answer:
    ...
    },
    {
      id: 30,
      question:
        "Difference between responsive coding and a mobile-first.",
      answer:
